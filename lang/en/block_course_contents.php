...
$string['config_defaultsectiontitle'] = 'Force section titles';
$string['config_defaultsectiontitle_label'] = 'If enabled, the block is forced to use the section titles. Otherwise, if no individual section title is set, it will take the summary as the title.';
$string['admin_lock'] = 'Lock setting';
$string['admin_lock_desc'] = 'If enabled, this setting is locked and only admins can change this. Teachers are not able to change the setting individually.';
$string['admin_heading_blocktitle'] = "Blocktitle";
$string['admin_heading_enumeration'] = "Enumeration";
$string['admin_heading_titles'] = "Titles";
